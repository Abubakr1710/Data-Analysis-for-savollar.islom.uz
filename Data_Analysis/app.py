...
with header: # Creating a header.
    #image = Image.open('https://github.com/Abubakr1710/Data-Analysis-for-savollar.islom.uz/blob/main/Data_Analysis/assets/picture.png') # Opening the logo image.
    st.sidebar.image('https://github.com/Abubakr1710/Data-Analysis-for-savollar.islom.uz/blob/main/Data_Analysis/assets/picture.png', use_column_width=True) # Displaying the logo image.
