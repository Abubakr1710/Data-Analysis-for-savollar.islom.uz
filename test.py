...
if choice == "Bosh Sahifa":
    ...
    st.markdown("<h5 style='text-align: center; color: black;'>DATA TEAM guruhi tomonidan savollar.islom.uz veb ilovasi uchun tayyorlangan Ma'lumotlar tahlili.</h5>", unsafe_allow_html=True)
