...
st.sidebar.markdown("<h1 style='text-align: center; color: black;'>DATA CLUB</h1>", unsafe_allow_html=True) # Creating a header.
...
if choice == "Bosh Sahifa":
    ...
    st.markdown("<h5 style='text-align: center; color: black;'>DATA CLUB tomonidan savollar.islom.uz veb ilovasi uchun tayyorlangan Ma'lumotlar tahlili.</h5>", unsafe_allow_html=True)
